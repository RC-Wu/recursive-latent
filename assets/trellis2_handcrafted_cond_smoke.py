...
def main():
    ...
    local = args.out / "handcrafted_cond_pipeline"
    ...
    try:
        ...
        write_obj(args.out / "trellis2_handcrafted_cond.obj", vertices, faces)
        render_preview(args.out / "trellis2_handcrafted_cond_preview.png", vertices, f"handcrafted cond seed {args.seed}")
        summary = {
            "kind": "handcrafted_image_feature_proxy_not_official_trellis2",
