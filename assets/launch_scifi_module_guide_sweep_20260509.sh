...
RUN="${RUN:-scifi_module_guide_sweep_20260509}"
...
MESH="$ROOT/inputs/connected_scaffold_cases_v2_20260509/sci_fi_recursive_module/sci_fi_recursive_module.obj"
...
declare -a CASES=(
  "4 gear_train_square.png scifi_gear_hq"
  "5 washington_square_arch_square.png scifi_arch_hq"
  "6 pyrite_cubes_square.png scifi_pyrite_hq"
  "7 bismuth_crystal_square.png scifi_bismuth_hq"
)
...
for spec in "${CASES[@]}"; do
  ...
  script="$LOG/run_gpu${gpu}_${label}.sh"
  {
    ...
    echo "ROOT='$ROOT' RUN='$RUN' source '$ROOT/assets/launch_scifi_module_guide_sweep_20260509.sh' --worker '$gpu' '$guide' '$label'"
  } > "$script"
  chmod +x "$script"
