...
def main():
    ...
    local = args.out / "dinov2_proxy_pipeline"
    ...
    try:
        ...
        write_obj(args.out / "trellis2_dinov2_proxy.obj", vertices, faces)
        render_preview(args.out / "trellis2_dinov2_proxy_preview.png", vertices, f"DINOv2 proxy seed {args.seed}")
        summary = {
            "kind": "dinov2_proxy_conditioned_smoke_not_official_trellis2",
