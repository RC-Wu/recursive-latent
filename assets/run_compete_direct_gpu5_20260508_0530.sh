...
export TRITON_CACHE_DIR="$ROOT/cache/triton/compete_direct_gpu5_20260508_0530"
...
"$MESHVAE_ENV/bin/python" "$ROOT/assets/trellis2_recursive_slat_grammar_workflow.py" \
  ...
  --out "$ROOT/results/siga_compete_grammar/compete_direct_dla_gpu5_20260508_0530" \
  --case-name "compete_direct_dla_root" \
  --grammars compete compete_fork radial side echo \
  --depths 4 \
  --resolution 512 \
  --grid-resolution 512 \
  --fit-scale 0.58 \
