...
DEFAULT_OUT = ROOT_DIR / "results" / "fern_depth_roots_20260512k"
...
def _case_specs():
    return [
        ("fiddlehead_log_spiral_pure_k", "fiddlehead", "open", 202612001),
        ("fiddlehead_log_spiral_pure_l", "fiddlehead", "dense", 202612002),
        ("fern_mesh_frond_k", "fern", "broad", 202612003),
        ("fern_mesh_frond_l", "fern", "open", 202612004),
    ]


def _render_contact(out_dir: Path, rows: List[Dict]) -> Dict:
    out = out_dir / "fern_depth_roots_contact_sheet_20260512k.png"
    cmd = [
        sys.executable,
...
def main() -> None:
    ...
    summary = {
        ...
        "revision": "20260512k per-depth connected roots",
    }
