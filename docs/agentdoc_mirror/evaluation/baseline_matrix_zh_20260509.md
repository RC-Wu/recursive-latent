...
输出目录：`results/baseline_matrix_20260509`

Contact sheet：`results/baseline_matrix_20260509/contact_sheet_final_depth.png`
...
- Same-seed：`20260509`，脚本内部只加固定 case/method offset，避免 Python hash 随进程漂移。
...
|---|---|---:|---:|---:|---:|---:|---:|
| tree | lsystem | 1 | 1.0000 | 1.0000 | 27 | 13 | 1 |
| tree | space_colonization | 1 | 1.0000 | 1.0000 | 143 | 89 | 9 |
| tree | proposed_connected | 1 | 1.0000 | 1.0000 | 9 | 4 | 1 |
| root | lsystem | 1 | 1.0000 | 1.0000 | 27 | 13 | 1 |
| root | space_colonization | 1 | 1.0000 | 1.0000 | 118 | 78 | 9 |
| root | proposed_connected | 1 | 1.0000 | 1.0000 | 7 | 3 | 1 |
| vine | lsystem | 1 | 1.0000 | 1.0000 | 4 | 3 | 1 |
| vine | space_colonization | 1 | 1.0000 | 1.0000 | 124 | 68 | 24 |
