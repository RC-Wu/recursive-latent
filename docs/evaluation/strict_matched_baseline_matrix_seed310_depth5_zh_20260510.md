...
输出目录：`results/strict_matched_baseline_matrix_20260510_seed310_depth5`

Contact sheet：`results/strict_matched_baseline_matrix_20260510_seed310_depth5/contact_sheet_final_depth.png`
...
- Same-seed：`20260510`，脚本内部只加固定 case/method offset，避免 Python hash 随进程漂移。
- Same-depth：`1..5`；CSV 每行都记录 `same_max_depth=5`。
...
|---|---|---:|---:|---:|---:|---:|---:|
| tree | lsystem | 1 | 1.0000 | 1.0000 | 81 | 40 | 1 |
| tree | space_colonization | 1 | 1.0000 | 1.0000 | 134 | 95 | 3 |
| tree | proposed_connected | 1 | 1.0000 | 1.0000 | 17 | 8 | 1 |
| root | lsystem | 1 | 1.0000 | 1.0000 | 81 | 40 | 1 |
| root | space_colonization | 1 | 1.0000 | 1.0000 | 161 | 106 | 7 |
| root | proposed_connected | 1 | 1.0000 | 1.0000 | 13 | 6 | 1 |
| vine | lsystem | 1 | 1.0000 | 1.0000 | 5 | 4 | 1 |
| vine | space_colonization | 1 | 1.0000 | 1.0000 | 114 | 74 | 6 |
| vine | proposed_connected | 1 | 1.0000 | 1.0000 | 7 | 4 | 1 |
